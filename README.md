...
## Table of contents
  ...
  - [Getting Started](#getting-started)
      ...
      - [4. Configure the project to talk to Elasticpath](#4-configure-the-project-to-talk-to-elaticpath)
      - [5. Up and Running!](#7-up-and-running)
  - [Deploy](#deploy)
...
but this time set the Elasticpath client id.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fbuilderio%2Fnextjs-elasticpath)
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/BuilderIO/nextjs-elasticpath)
